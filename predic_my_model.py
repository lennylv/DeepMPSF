...
from My_Model import My_Model_testing
matplotlib.use('Agg')
...
def main():
    ...
    Tablefile_test = '../data/Table_All_test_general_ST.csv'
    ...
    My_Model_testing(shuffled_table_df_test, modelname, shuffled_table_df_val, torch.device('cuda:2'))
