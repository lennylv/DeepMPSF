...
from Method_ori_local_global_1_2 import split_shuffle_val_train_csvfile, get_test_data_csv
from My_Model import My_Model_Blindtesting
import sys
...
def main():
    ...
    Tablefile_test = '../data/Table_blind_human_ST_2k.csv'
    ...
    My_Model_Blindtesting(shuffled_table_df_test, modelname, shuffled_table_df_val, torch.device('cuda:2'))
