...
from My_Model import My_Model_Blindtesting_Rattus
import sys
...
def main():
    ...
    Tablefile_test = '../data/Table_blind_Rattus_ST.csv'
    ...
    My_Model_Blindtesting_Rattus(shuffled_table_df_test, modelname, shuffled_table_df_val, torch.device('cuda:2'))
